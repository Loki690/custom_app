                                        ...
                                        <div class="row">
                                            <div class="col-lg">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" data-fieldname="total_amount" value="${rate2}" readonly />
                                                </div>
                                            </div>
                                        </div>
                                    `
  ...
  custom_app.PointOfSale.ItemCart = class {
    ...
    render_cart_item(item_data, $item_to_update) {
      ...
      function get_rate_discount_html(customer_group2) {
        ...
        } else if (customer_group2 === "Senior Citizen" || customer_group2 === "PWD Customers") {
          return `
						<div class="item-qty-rate">
							<div class="item-qty"><span>${item_data.qty || 0} ${item_data.uom}</span></div>
							<div class="item-rate-amount">
...
//# sourceMappingURL=packing-list.bundle.MD6KDKH5.js.map
