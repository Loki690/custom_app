(() => {
  ...
  custom_app.PointOfSale.ItemCart = class {
    ...
    update_totals_section(frm) {
      ...
      const custom_vatable_sales = cint(frappe.sys_defaults.disable_rounded_total) ? frm.doc.custom_vatable_sales : frm.doc.rounded_total;
      const custom_vat_exempt_sales = cint(frappe.sys_defaults.disable_rounded_total) ? frm.doc.custom_vat_exempt_sales : frm.doc.rounded_total;
      const custom_zero_rated_sales = cint(frappe.sys_defaults.disable_rounded_total) ? frm.doc.custom_zero_rated_sales : frm.doc.rounded_total;
      ...
      const net_total = cint(frappe.sys_defaults.disable_rounded_total) ? frm.doc.net_total : frm.doc.rounded_total;
              ...
              const changeDialog = new frappe.ui.Dialog({
                ...
                primary_action: () => {
                  if (this.recent_order_list && this.recent_order_list.search_field) {
                    this.recent_order_list.search_field.set_value("");
                  }
                  this.pending_orders();
                  changeDialog.hide();
                }
...
//# sourceMappingURL=amesco-point-of-sale.bundle.NCXLMXJQ.js.map
