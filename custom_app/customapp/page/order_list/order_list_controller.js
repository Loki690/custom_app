erpnext.PointOfSale.Controller = class {
	...
	prepare_buttons() {
		...
		this.page.add_button(__("Toggle Recent Orders"), this.toggle_recent_order.bind(this), "octicon octicon-sync", "btn-secondary", "Ctrl+O");
		this.page.add_button(__("Toggle Recent Orders"), this.toggle_recent_order.bind(this), "octicon octicon-sync", "btn-secondary", "Ctrl+O");
		this.page.add_button(__("Toggle Recent Orders"), this.toggle_recent_order.bind(this), "octicon octicon-sync", "btn-secondary", "Ctrl+O");
		...
		frappe.call({
			...
			callback: (response) => {
				if (response.message) {
					...
					// Now you have the pharmacist user's ID in 'pharmacistUser'
