...
erpnext.PointOfSale.ItemSelector = class {
	...
	get_items({ start = 0, page_length = 40, search_term = "" }) {
		...
		return frappe.call({
			method: "erpnext.selling.page.order_list.order_list.get_items",
			freeze: true,
			args: {
				start,
				page_length,
	...
	get_serial_number() {
		frappe.call({
			method: "erpnext.selling.page.order_list.order_list.serial_number", // Replace with the correct path
